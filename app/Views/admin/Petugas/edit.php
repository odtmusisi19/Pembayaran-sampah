        ...
        <div class="card">
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              <form method="post" action="<?= base_url('petugas/update/' . $petugas->id_petugas) ?>" enctype="multipart-form-data">
                <?= csrf_field(); ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="password" name="tanggal_lahir" value="<?= $petugas->password; ?>" />
                </div>
                <div class="form-group">
